...
<div class="card">
    <form method="POST" action="{{ route('tasks.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" class="form-control ckeditor-field">{{ old('description') }}</textarea>
        ...
        <div class="form-group">
            ...
            <select id="requested_by" name="requested_by" class="form-control">
                ...
                @foreach($users as $user)
                    <option value="{{ $user->id }}" {{ old('requested_by') == $user->id ? 'selected' : '' }}>{{ $user->name }} ({{ $user->email }})</option>
                @endforeach
            </select>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select id="status" name="status" class="form-control">
                    ...
                    <option value="in_review" {{ old('status') == 'in_review' ? 'selected' : '' }}>{{ __('messages.in_review') }}</option>
